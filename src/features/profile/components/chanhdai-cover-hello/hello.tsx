...
import { AnishPrashunMark } from "@/components/anishpras-mark";
import { Button } from "@/components/ui/button";
import { SimpleTooltip } from "@/components/ui/tooltip";
import { AppleHelloVietnameseEffect } from "@/registry/apple-hello-effect";

const layers = ["hello", "anishprashun-wordmark"] as const;
    ...
    <>
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          {layers[currentIndex] === "anishprashun-wordmark" && (
            <motion.div
            ...
            >
              <AnishPrashunMark className="h-12 sm:h-16" />
            </motion.div>
          )}
        </div>
      </AnimatePresence>
